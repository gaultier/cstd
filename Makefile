...
CFLAGS = -fpie -fno-omit-frame-pointer -march=native -fuse-ld=$(LD) -std=c23 -Wall -Wextra -Wno-cast-function-type-mismatch -Werror -Wpadded -Wimplicit-fallthrough -Wunused -Wunused-variable -g3
