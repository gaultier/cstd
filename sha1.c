 ...
 */
static void SHA1Transform(u_int32_t state[5],
 ...
 */
static void SHA1Update(SHA1_CTX *context, const u_int8_t *data, size_t len) {
  size_t i, j;
...
static void SHA1Final(u_int8_t digest[SHA1_DIGEST_LENGTH], SHA1_CTX *context) {
  size_t i;
