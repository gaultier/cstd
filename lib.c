...
__attribute((warn_unused_result)) static bool pg_bitfield_get_ptr(u8 *bitfield, u64 bitfield_len,
                                              u64 idx_bit) {
...
__attribute((warn_unused_result)) static PgArena pg_arena_make_from_mem(u8 *data, u64 len) {
  PgArena arena = {
      .start = data,
      .end = data + len,
      .start_original = data,
