...
pg_dwarf_resolve_string(Pgu8Slice str_offsets_bytes, Pgu8Slice str_bytes,
                        u64 idx) {
  // TODO: Non-crashing bounds check.
  u32 str_idx = *(u32 *)PG_SLICE_AT_PTR(&str_offsets_bytes, idx * sizeof(u32));
