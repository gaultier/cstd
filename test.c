...
static void test_cli_options_parse() {
  ...
  // Long option given with `=` and the value looks like an option.
  {
    PG_DYN(PgCliOptionDescription) descs = {0};
    PG_DYN_PUSH(&descs,
                ((PgCliOptionDescription){
    ...
    PG_ASSERT(1 == opt0.values.len);
    PgString opt0_value0 = PG_SLICE_AT(opt0.values, 0);
    PG_ASSERT(pg_string_eq(opt0_value0, PG_S("--hidden")));
  }
...
int main(int argc, char *argv[]) {
  PgTest tests[] = {
    ...
    PG_TEST(test_string_first),
    PG_TEST(test_string_index_of_rune),
    PG_TEST(test_string_last_index_of_rune),
    PG_TEST(test_slice_range),
    PG_TEST(test_utf8_iterator),
    PG_TEST(test_string_index_of_string),
    PG_TEST(test_string_trim),
    PG_TEST(test_string_cut),
    PG_TEST(test_string_split_byte),
    PG_TEST(test_string_split_string),
    PG_TEST(test_dyn_ensure_cap),
    PG_TEST(test_path_stem),
    PG_TEST(test_string_consume),
    PG_TEST(test_string_parse_u64),
    PG_TEST(test_string_cmp),
    PG_TEST(test_sha1),
    PG_TEST(test_slice_swap_remove),
    PG_TEST(test_dynu8_append_u8_hex_upper),
    PG_TEST(test_ipv4_address_to_string),
    PG_TEST(test_url_encode),
    PG_TEST(test_string_index_of_any_byte),
    PG_TEST(test_u8x4_be_to_u32_and_back),
    PG_TEST(test_bitfield),
    PG_TEST(test_ring_buffer_read_write),
    PG_TEST(test_ring_buffer_read_write_fuzz),
    PG_TEST(test_url_parse_relative_path),
    PG_TEST(test_url_parse),
    PG_TEST(test_http_request_to_string),
    PG_TEST(test_http_parse_response_status_line),
    PG_TEST(test_http_parse_request_status_line),
    PG_TEST(test_http_parse_header),
    PG_TEST(test_http_read_request_full_no_content_length),
    PG_TEST(test_http_read_request_no_body_separator),
    PG_TEST(test_http_read_request_full_without_headers),
    PG_TEST(test_http_read_request_full_without_body),
#if 0
  ...
  test_http_request_response();
    ...
    PG_TEST(test_log),
    PG_TEST(test_div_ceil),
    PG_TEST(test_path_base_name),
    PG_TEST(test_process_no_capture),
    PG_TEST(test_process_capture),
    PG_TEST(test_process_stdin),
    PG_TEST(test_linked_list),
    PG_TEST(test_html_tokenize_no_attributes),
    PG_TEST(test_html_tokenize_with_key_no_value),
    PG_TEST(test_html_tokenize_with_attributes),
    PG_TEST(test_html_tokenize_nested),
    PG_TEST(test_html_tokenize_with_doctype),
    PG_TEST(test_html_tokenize_with_comment),
    PG_TEST(test_html_parse),
    PG_TEST(test_html_parse_title_with_html_content),
    PG_TEST(test_string_escape_js),
    PG_TEST(test_string_builder_append_u64),
    PG_TEST(test_string_buillder_append_u64_hex),
    PG_TEST(test_adjacency_matrix),
    PG_TEST(test_thread),
